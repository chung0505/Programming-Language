...
def insert_stop_words(file_name):
...
# The main function
#
print_all(sort(frequencies(insert_stop_words("./txt_file/stop_words.txt")(scan(filter_chars_and_normalize(read_file(sys.argv[1]))))))[0:25])